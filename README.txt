...
This includes a small Access VBA Project demonstrates the use of a global class object that uses custom events to allow forms to communicate with each other.   This allows forms to encapsulate functionality within the form, relieving other forms from needing to know anything about the forms they are talking to. 
